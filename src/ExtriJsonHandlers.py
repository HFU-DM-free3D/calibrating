...
class ExtriJsonCreator:
    def __init__(self, all_extris: CamExtris, path):
        self.all_extris = all_extris
        cam_extris_dict_list = [cam_extris.to_dict() for cam_extris in all_extris]
        print(cam_extris_dict_list)
        cam_extrinsics = {
